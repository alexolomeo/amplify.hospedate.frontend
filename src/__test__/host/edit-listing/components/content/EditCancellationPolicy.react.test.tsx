...
jest.mock('@/components/React/Hooks/useDebounce', () => ({
  ...
  rules: [
    {
      ...
      refund: { percentage: 100, includeServiceFee: true },
      nonRefundableNights: 0,
      descriptionKey: 'cancellation_policy_standard_rule_firm_full_refund',
      descriptionPlaceholders: { deadline: '2025-05-02T08:00:00' },
    },
    {
    ...
    },
    {
      ...
      bookingWindowHours: 0,
      refund: { percentage: 50, includeServiceFee: false },
      nonRefundableNights: 0,
    ...
    },
    {
      ...
      bookingWindowHours: 0,
      refund: { percentage: 0, includeServiceFee: false },
      nonRefundableNights: 0,
      descriptionKey: 'cancellation_policy_standard_rule_firm_no_refund',
      descriptionPlaceholders: { deadline: '2025-06-01T08:00:00' },
    },
  ],
};
...
it('should not render summaryText if isError or isGuestCountValid is false', () => {
  render(
    <ListingCancellationPolicy
      cancellationPolicy={mockCancellationPolicy}
      checkIn={new Date()}
